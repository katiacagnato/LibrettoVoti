...
public class FXMLController {
 ...
 //  private TextField txtData;
    ...
    void handleInserisci(ActionEvent event) {
    	...
    	{
    		txtResult.setText("ERRORE: nome esame non esistente");
    		return;	//cosi non modifico il modello se i dati sono sbagliati
    	}
...
//    		txtResult.setText("ERRORE: data non valida");
//    		return ;
...
//        assert txtData != null : "fx:id=\"txtData\" was not injected: check your FXML file 'Scene.fxml'.";
    ...
    public void setModel(Libretto model) {	//MODIFICA
    	this.model = model;
    }
